...
- [26.21 - v2.0.1](https://github.com/lpsmods/assets-plus/releases/tag/v2.0.1)
- [1.21.44 - v1.7.0](https://github.com/lpsmods/assets-plus/releases/tag/v1.7.0)
- [1.20.12 - v1.5.0](https://github.com/lpsmods/assets-plus/releases/tag/v1.5.0)
- [1.19.80 - v1.4.0](https://github.com/lpsmods/assets-plus/releases/tag/v1.4.0)
- [1.19 - v1.3.0](https://github.com/lpsmods/assets-plus/releases/tag/v1.3.0)
...
You can find a list of all texture IDs via the [Documentation Page](https://docs.lpsmods.dev/assets-plus/)

### What do I do if I found an issue with the library?

You can submit all issues and suggestions via [GitHub](https://github.com/lpsmods/assets-plus/issues)
